-- SQL JOINS PRACTICE FILE
-- তৈরি করা হয়েছে Customers, Orders, Payments, Employees টেবিল এবং সব JOIN প্রশ্নের সমাধানসহ
...
-- Q2. All customers and their orders (including customers with no orders)
SELECT c.CustomerID, c.CustomerName, o.OrderID, o.OrderDate, o.Amount
FROM Customers c
LEFT JOIN Orders o ON c.CustomerID = o.CustomerID;

-- Q3. All orders with their customers (including orders with unknown customers)
SELECT c.CustomerID, c.CustomerName, o.OrderID, o.OrderDate, o.Amount
FROM Customers c
RIGHT JOIN Orders o ON c.CustomerID = o.CustomerID;

-- Q4. All customers and orders whether matched or not
SELECT c.CustomerID, c.CustomerName, o.OrderID, o.OrderDate, o.Amount
FROM Customers c
LEFT JOIN Orders o ON c.CustomerID = o.CustomerID
UNION
...
-- Q6. Customers who made payments but did not place any orders
